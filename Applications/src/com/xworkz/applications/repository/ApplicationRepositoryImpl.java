...
public class ApplicationRepositoryImpl implements ApplicationRepository{
    ...
    public List<ApplicationDto> findAll() {
        ...
        ApplicationDto dto32 = new ApplicationDto("DreamHouse", ApplicationVersion.MAINTENANCE, LocalDate.of(2021, 5, 8), 40.5, ApplicationType.DESKTOP, true, 0.0, Arrays.asList(new OwnerDto("Maya", "maya.g@example.com", 9334442211L)));
