...
<div class="form-container">
    ...
    <form action="donate" method="post" class="row g-3">
        ...
        <div class="col-12">
            ...
            <input type="email" class="form-control" name="exampleFormControlInput1" placeholder="abc@example.com" required>
        </div>
        <div class="col-md-6">
            <label class="form-label">Amount</label>
            <input type="number" class="form-control" name="inputnum">
        </div>
        <div class="col-md-6">
            <label class="form-label">Cause</label>
            <input type="text" class="form-control" name="inputcause">
        </div>
        <div class="col-12 text-center mt-3">
            <button type="submit" class="btn btn-beige px-5">Donate</button>
        </div>
    </form>
</div>
